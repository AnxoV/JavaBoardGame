...
/**
 * The {@code ArrayLogic} class provides static methods to perform logic operations with Java arrays. 
 * 
 * @since JDK 1.11
 * @version 1.0
 * 
 * @see {@link src.Logic.ArrayLogic#min(int[]) min(int[])}
 * @see {@link src.Logic.ArrayLogic#max(int[]) max(int[])}
 * @see {@link src.Logic.ArrayLogic#sum(int[], int[]) sum(int[], int[])}
 */
